...
export const MATRIX_BLOCKED_TERMS = [
  ...
  'scramjet', 'scrammerjet', 'ultraviolet', 'uv proxy', 'rammerhead', 'corrosion',
  'rhodium', 'wisp server', 'bare server', 'holy unblocker', 'incognito unblocker',
  'titanium network', 'interstellar proxy', 'selenite', 'nebula proxy', 'metallic proxy',
  'shuttle proxy', 'artclass', 'luna proxy', 'croxyproxy', 'proxysite', 'kproxy', 'web proxy',
  'gn math', 'classroom 6x', 'coolmath', 'coolmath games', 'cool math games', 'math playground',
  'hoodamath', 'tyrone unblocked', 'tyrone games', 'ubg100', 'crazygames', 'poki', 'now gg',
  'goguardian bypass', 'securly bypass', 'bypass goguardian', 'bypass securly',
  'disable goguardian', 'kill goguardian', 'extension killer', 'tab cloaker', 'tab cloaking',
  'dextensify', 'ltmeat', 'caub',
  'blooket hack', 'blooket bot', 'kahoot bot', 'kahoot spammer', 'gimkit bot',
  ...
  'chatgpt', 'gemini', 'claude', 'ai chatbot',
