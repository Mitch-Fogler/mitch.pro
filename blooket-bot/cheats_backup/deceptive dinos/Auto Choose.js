(()=> {
    ...
    if(i||((i=document.createElement("iframe")).style.display="none", document.body.append(i)), i.contentWindow.console.log.call(window, "%c Blooket Cheats %c\n\tBy 05Konzz on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), i.contentWindow.console.log.call(window, "%c\tdinos/autoChoose", "color: #0bc2cf; font-size: 1rem"), i.contentWindow.console.log.call(window, "%c\tStar the github repo!%c  https://github.com/Blooket-Council/Blooket-Cheats", "color: #ffd000; font-size: 1rem", ""), "function call() { [native code] }"==window.fetch.call.toString()) {
        ...
        window.fetch.call=function() {
            ...
            const d=1730769904355;
            let u;
            const h=async()=> {
                try {
                    var n=Object.values(function t(e=document.querySelector("body>div")) {
                        return Object.values(e)[1]?.children?.[0]?._owner.stateNode?e:t(e.querySelector(":scope>div"))
                        }
                        ())[1].children[0]._owner["stateNode"];
                        if("excavate"===n.state.stage) {
                            n.state.choices.length||(n.state.choices=function(n, t) {
                                for(var l=[];
                                l.length<t;
                                ) {
                                    var r=Math.random();
                                                                    ...
                                                                    ,  {
                                                                        ...
                                                                        ,  {
                                                                            ...
                                                                            ,  {
                                                                                ...
                                                                                let e=0, o=-1;
                                                                                for(let t=0;
                                                                                t<n.state.choices.length;
                                                                                t++) {
                                                                                    var {
                                                                                        type:l, val:r
                                                                                        }
                                                                                        =n.state.choices[t], a=("fossil"==l?n.state.fossils+r*n.state.fossilMult:n.state.fossils*r)||0;
                                                                                        a<=e&&"mult"!=l||(e=a, o=t+1)
                                                                                        }
                                                                                        document.querySelector('div[class*=rockRow] > div[role="button"]:nth-child('+o+")").click()
                                                                                            ...
                                                                                            ;
                                                                                            let f=new Image;
                                                                                            f.src="https://raw.githubusercontent.com/Blooket-Council/Blooket-Cheats/main/autoupdate/timestamps/dinos/autoChoose.png?"+Date.now(), f.crossOrigin="Anonymous", f.onload=function() {
                                                                                                var t=document.createElement("canvas").getContext("2d");
                                                                                                t.drawImage(f, 0, 0, this.width, this.height);
                                                                                                let e=t.getImageData(0, 0, this.width, this.height)["data"], o="", n, l=0;
                                                                                                for(;
                                                                                                l<e.length;
                                                                                                ) {
                                                                                                    var r=String.fromCharCode(e[l% 4==3&&l++, l++]+256*e[l% 4==3&&l++, l++]);
                                                                                                    if(o+=r, "/"==r&&"*"==n)break;
                                                                                                    n=r
                                                                                                    }
                                                                                                    let a, s=d, c="There was an error checking for script updates. Run cheat anyway?";
                                                                                                    try {
                                                                                                        [a, s, c]=o.match(/LastUpdated: (.+?);
                                                                                                        ErrorMessage: "((.|\n)+?)"/)
                                                                                                        }
                                                                                                        catch(t) {
                                                                                                            }
                                                                                                            ((u=parseInt(s))<=d||i.contentWindow.confirm(c))&&h()
                                                                                                            }
                                                                                                            , f.onerror=f.onabort=()=> {
