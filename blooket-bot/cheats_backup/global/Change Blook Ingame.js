(async () =>  {
    var e=document.createElement("iframe"), e=(document.body.append(e), window.prompt=window.prompt, e.remove(), (() =>  {
        const findReactNode = () =>  {
                                ...
                                while (fiber)  {
                                    if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                        ...
                                        e.liveGameController.setVal( {
                                            path:`c/${e.client.name}/b`, val:e.client.blook=prompt("Blook Name: (Case Sensitive)")
                                            }
                                            )
                                        }
                                        )();