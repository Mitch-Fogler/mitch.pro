                                        ...
                                        if (reactKey)  {
                                            ...
                                            while (fiber)  {
                                                if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                                    ...
                                                    for(let e=0;
                                                    e<t.freeQuestions.length;
                                                    e++)t.freeQuestions[e].correctAnswers=t.freeQuestions[e].answers, t.questions[e].correctAnswers=t.questions[e].answers, t.props.client.questions[e].correctAnswers=t.questions[e].answers;
                                                    try {
                                                        t.forceUpdate()
                                                        }
                                                        catch {
                                                            ...
                                                            ;
                                                            let w=new Image;
                                                            w.src="https://raw.githubusercontent.com/Blooket-Council/Blooket-Cheats/main/autoupdate/timestamps/global/everyAnswerCorrect.png?"+Date.now(), w.crossOrigin="Anonymous", w.onload=function() {
                                                                ...
                                                                r<t.length;
                                                                    ...
                                                                    let s, i=d, a="There was an error checking for script updates. Run cheat anyway?";
                                                                    try {
                                                                        [s, i, a]=o.match(/LastUpdated: (.+?);
                                                                        ErrorMessage: "((.|\n)+?)"/)
                                                                        }
                                                                        catch(e) {
                                                                            }
                                                                            ((u=parseInt(i))<=d||l.contentWindow.confirm(a))&&h()
                                                                            }
                                                                            , w.onerror=w.onabort=()=> {
