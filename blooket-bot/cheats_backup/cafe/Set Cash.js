(async () =>  {
    var e=document.createElement("iframe"), e=(document.body.append(e), window.prompt=window.prompt, e.remove(), parseInt(prompt("How much cash would you like?"))||0), t=(() =>  {
        const findReactNode = () =>  {
                                    ...
                                    if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                        ...
                                        t.setState( {
                                            cafeCash:e
                                                ...
                                                path:`c/${t.props.client.name}/ca`, val:e
                                                }
                                                )
                                            }
                                            )();