                                        ...
                                        if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                            ...
                                            "prize"==a.state.stage&&a.props.liveGameController.getDatabaseVal("c", t=> {
                                                if(null!=t) {
                                                    ...
                                                    t++) {
                                                        var c=a.state.choices[t];
                                                        let e=a.state.gold;
                                                        "gold"==c.type?e=a.state.gold+c.val||a.state.gold:"multiply"==c.type||"divide"==c.type?e=Math.round(a.state.gold*c.val)||a.state.gold:"swap"==c.type?e=o||a.state.gold:"take"==c.type&&(e=a.state.gold+o*c.val||a.state.gold), (e||0)<=n||(n=e, l=t+1)
                                                        }
                                                        document.querySelector("div[class*='choice"+l+"']")?.click()
                                                        }
                                                        }
                                                        )
                                                        }
