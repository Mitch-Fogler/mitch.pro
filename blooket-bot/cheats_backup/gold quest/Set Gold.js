(async () =>  {
    var e=document.createElement("iframe"), e=(document.body.append(e), window.prompt=window.prompt, e.remove(), parseInt(prompt("How much gold would you like?"))||0), t=(() =>  {
        const findReactNode = () =>  {
                                    ...
                                    if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                        ...
                                        t.setState( {
                                            gold:e, gold2:e
                                                ...
                                                path:"c/"+t.props.client.name+"/g", val:e
                                                }
                                                )
                                            }
                                            )();