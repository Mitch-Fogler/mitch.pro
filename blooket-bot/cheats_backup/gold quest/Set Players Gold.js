(async () =>  {
    var e=document.createElement("iframe"), e=(document.body.append(e), window.prompt=window.prompt, e.remove(), prompt("Who's gold would you like to set?")), t=parseInt(prompt("How much gold would you like to set?"))||0, o=(() =>  {
        const findReactNode = () =>  {
                                ...
                                while (fiber)  {
                                    if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                        ...
                                        o.props.liveGameController.setVal( {
                                            path:"c/"+o.props.client.name+"/tat", val:e+":swap:"+t
                                            }
                                            )
                                        }
                                        )();