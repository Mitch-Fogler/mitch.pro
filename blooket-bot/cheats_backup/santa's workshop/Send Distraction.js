        ...
        window.fetch.call=function() {
            ...
            const w=async()=> {
                var e=document.createElement("iframe"), e=(document.body.append(e), window.alert=window.alert, e.remove(), Object.values(function e(t=document.querySelector("body>div")) {
                    ...
                    ())[1].children[0]._owner)["stateNode"], t= {
                        c:"Oh Canada", b:"Blizzard", f:"Fog Spell", d:"Dark & Dusk", w:"Howling Wind", g:"Gift Time!", t:"TREES", s:"Snow Plow", fr:"Use The Force"
                        }
                        , o=Object.keys(t)[Math.floor(9*Math.random())];
                        e.safe=!0, e.props.liveGameController.setVal( {
                            path:`c/${e.props.client.name}/tat`, val:o
                            }
                            ), alert(`Sent a ${t[o]} distraction`)
                            }
                            ;
                            let m=new Image;
                            m.src="https://raw.githubusercontent.com/Blooket-Council/Blooket-Cheats/main/autoupdate/timestamps/workshop/sendDistraction.png?"+Date.now(), m.crossOrigin="Anonymous", m.onload=function() {
                                ...
                                r<t.length;
                                    ...
                                    try {
                                        ...
                                        ErrorMessage: "((.|\n)+?)"/)
                                            ...
                                            ((h=parseInt(i))<=d||s.contentWindow.confirm(l))&&w()
                                            }
                                            , m.onerror=m.onabort=()=> {
                                                m.onerror=m.onabort=null, w(), window.alert("It seems the GitHub is either blocked or down.\n\nIf it's NOT blocked, join the Discord server for updates\nhttps://discord.gg/jHjGrrdXP6\n(The cheat will still run after this alert)")
                                                }
                                            }
                                            )();