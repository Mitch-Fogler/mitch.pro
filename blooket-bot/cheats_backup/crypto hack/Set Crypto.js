(async () =>  {
    var e=document.createElement("iframe"), e=(document.body.append(e), window.prompt=window.prompt, e.remove(), parseInt(prompt("How much crypto would you like?"))||0), t=(() =>  {
        const findReactNode = () =>  {
                                    ...
                                    if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                        ...
                                        t.setState( {
                                            crypto:e, crypto2:e
                                                ...
                                                path:`c/${t.props.client.name}/cr`, val:e
                                                }
                                                )
                                            }
                                            )();