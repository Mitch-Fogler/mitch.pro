(async () =>  {
    var e=document.createElement("iframe"), e=(document.body.append(e), window.prompt=window.prompt, e.remove(), prompt("What do you want to set your password to?")), t=(() =>  {
        const findReactNode = () =>  {
                                    ...
                                    if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                        ...
                                        t.setState( {
                                            password:e
                                                ...
                                                path:`c/${t.props.client.name}/p`, val:e
                                                }
                                                )
                                            }
                                            )();