                            ...
                            if (reactKey)  {
                                ...
                                while (fiber)  {
                                    if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                        ...
                                        const o=prompt("Who's gold would you like to swap with? (Case sensitive)");
                                        t.props.liveGameController.getDatabaseVal("c", e=> {
                                            e&&null!=e[o]&&(e=e[o].g||0, t.props.liveGameController.setVal( {
                                                path:"c/"+t.props.client.name, val: {
                                                    b:t.props.client.blook, tat:o+":swap:"+(t.state.gold||0), g:e
                                                    }
                                                    }
                                                    ), t.setState( {
                                                        gold:e, gold2:e
