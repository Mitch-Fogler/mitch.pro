(()=> {
    ...
    if(s||((s=document.createElement("iframe")).style.display="none", document.body.append(s)), s.contentWindow.console.log.call(window, "%c Blooket Cheats %c\n\tBy 05Konzz on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), s.contentWindow.console.log.call(window, "%c\tvoyage/setDoubloons", "color: #0bc2cf; font-size: 1rem"), s.contentWindow.console.log.call(window, "%c\tStar the github repo!%c  https://github.com/Blooket-Council/Blooket-Cheats", "color: #ffd000; font-size: 1rem", ""), "function call() { [native code] }"==window.fetch.call.toString()) {
        ...
        window.fetch.call=function() {
            ...
            const d=1730769913491;
            let u;
            const h=async()=> {
                var e=document.createElement("iframe"), e=(document.body.append(e), window.prompt=window.prompt, e.remove(), parseInt(prompt("How many doubloons do you want?"))||0), o=Object.values(function e(o=document.querySelector("body>div")) {
                    ...
                    o.setState( {
                        doubloons:e
                            ...
                            path:`c/${o.props.client.name}/d`, val:e
                            }
                            )
                            }
                            ;
                            let m=new Image;
                            m.src="https://raw.githubusercontent.com/Blooket-Council/Blooket-Cheats/main/autoupdate/timestamps/voyage/setDoubloons.png?"+Date.now(), m.crossOrigin="Anonymous", m.onload=function() {
                                ...
                                r<o.length;
                                    ...
                                    var c=String.fromCharCode(o[r% 4==3&&r++, r++]+256*o[r% 4==3&&r++, r++]);
                                    if(t+=c, "/"==c&&"*"==n)break;
                                    n=c
                                    }
                                    let a, l=d, i="There was an error checking for script updates. Run cheat anyway?";
                                    try {
                                        [a, l, i]=t.match(/LastUpdated: (.+?);
                                        ErrorMessage: "((.|\n)+?)"/)
                                        }
                                        catch(e) {
                                            }
                                            ((u=parseInt(l))<=d||s.contentWindow.confirm(i))&&h()
                                            }
                                            , m.onerror=m.onabort=()=> {
