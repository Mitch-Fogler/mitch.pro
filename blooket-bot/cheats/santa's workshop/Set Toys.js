(async () =>  {
    var e=document.createElement("iframe"), e=(document.body.append(e), window.prompt=window.prompt, e.remove(), parseInt(prompt("How many toys would you like?"))||0), t=(() =>  {
        const findReactNode = () =>  {
                                    ...
                                    if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                        ...
                                        t.setState( {
                                            toys:e
                                                ...
                                                path:"c/"+t.props.client.name+"/t", val:e
                                                }
                                                )
                                            }
                                            )();