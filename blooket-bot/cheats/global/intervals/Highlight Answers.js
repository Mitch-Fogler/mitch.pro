                                    ...
                                    while (fiber)  {
                                        if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                            ...
                                            n<o.answers.length;
                                                ...
                                                let t=!1;
                                                for(let e=0;
                                                e<o.correctAnswers.length;
                                                e++)if(o.answers[n]==o.correctAnswers[e]) {
                                                    t=!0;
                                                    break
                                                    }
                                                    n++, document.querySelector("[class*='answersHolder'] :nth-child("+n+") > div").style.backgroundColor=t?"rgb(0, 207, 119)":"rgb(189, 15, 38)"
                                                    }
                                                    }
                                                    , 50)
                                                }
