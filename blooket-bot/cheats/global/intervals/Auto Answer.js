                                                        ...
                                                        if("typing"!=e.state.question.qType)if("feedback"==e.state.stage||e.state.feedback)document.querySelector("[class*='feedback'], [id*='feedback']").firstChild.click();
                                                            ...
                                                            o++) {
                                                                ...
                                                                e++)if(n.answers[o]==n.correctAnswers[e]) {
                                                                    ...
                                                                    ;
                                                                    let f=new Image;
                                                                    f.src="https://raw.githubusercontent.com/Blooket-Council/Blooket-Cheats/main/autoupdate/timestamps/global/intervals/autoAnswer.png?"+Date.now(), f.crossOrigin="Anonymous", f.onload=function() {
