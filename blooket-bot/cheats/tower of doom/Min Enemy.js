        ...
        window.fetch.call=function() {
            ...
            const h=async()=> {
                var e=document.createElement("iframe"), e=(document.body.append(e), window.alert=window.alert, e.remove(), Object.values(function e(t=document.querySelector("body>div")) {
                    ...
                    "select"==e.state.phase?e.setState( {
                        enemyCard:Object.assign(Object.assign( {
                            }
                            , e.state.enemyCard),  {
                                ...
                                ;
                                let u=new Image;
                                u.src="https://raw.githubusercontent.com/Blooket-Council/Blooket-Cheats/main/autoupdate/timestamps/doom/minEnemy.png?"+Date.now(), u.crossOrigin="Anonymous", u.onload=function() {
                                    ...
                                    r<t.length;
                                        ...
                                        let a, i=d, s="There was an error checking for script updates. Run cheat anyway?";
                                        try {
                                            [a, i, s]=o.match(/LastUpdated: (.+?);
                                            ErrorMessage: "((.|\n)+?)"/)
                                            }
                                            catch(e) {
                                                }
                                                ((m=parseInt(i))<=d||l.contentWindow.confirm(s))&&h()
                                                }
                                                , u.onerror=u.onabort=()=> {
