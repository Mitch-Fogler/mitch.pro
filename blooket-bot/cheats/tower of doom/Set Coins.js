(async () =>  {
    ...
    if(document.body.append(e), window.alert=window.prompt, e.remove(), "/tower/battle"==window.location.pathname)try {
        (() =>  {
            const findReactNode = () =>  {
                                ...
                                if (reactKey)  {
                                    ...
                                    while (fiber)  {
                                        if (fiber.stateNode && (fiber.stateNode.setState || fiber.stateNode.props?.liveGameController))  {
                                            ...
                                            )().props.setTowerCoins(parseInt(prompt("How many coins would you like?"))||0)
                                            }
                                            catch {
                                                }
